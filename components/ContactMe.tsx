...
const { register, handleSubmit, } = useForm<Inputs>();
  ...
  return (
    <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        <h3 className='invisible sm:visible absolute top-16 first-letter:uppercase tracking-[20px] text-gray-500 text-2xl'>Contact
       </h3>
        <div className='flex flex-col space-y-10'>
            ...
            <div className='space-y-10'>
                ...
                <div className='flex items-center space-x-5 justify-center'>
                    <MapPinIcon className='text-[orange] h-7 w-7 animate-pulse'/>
            ...
            <form onSubmit={handleSubmit(onSubmit)}className='flex flex-col space-y-2 w-[380px] sm:w-fit mx-auto'>
                ...
                <button type='submit' className='bg-[orange] py-5 px-10 rounded-md text-black font-bold text-lg'>Submit</button>
            </form>
        </div>
    </div>
  )
