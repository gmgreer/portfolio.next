...
const Projects = ({projects}: Props) => {
  ...
  return (
    <motion.div 
        ...
        <h3 className='absolute top-12 first-letter:uppercase tracking-[20px] text-gray-500 text-2xl'>Projects
       </h3>
            ...
            {projects?.map((project,i)=>(
                <div key={project._id} className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                    ...
                    <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                        <h4 className='text-4xl font-semibold text-center'><span className='underline decoration-[orange]/50'>{project?.title}</span></h4>
